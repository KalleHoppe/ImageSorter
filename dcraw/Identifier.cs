...
//#if false
            ...
            //while (*--cp == ' ') *cp = 0;
            if (state.model.StartsWith(state.make, StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            else if (state.make.Equals("MINOLTA", StringComparison.InvariantCultureIgnoreCase))
            {
                state.load_raw = new unpacked_load_raw(state);
                state.maximum = 0xfff;
            ...
            else if (state.make.Equals("KODAK", StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            while (entries-- != 0)
            {
                ...
                switch (tag)
                {
                    ...
                    case 29:
                        ...
                        Console.WriteLine("TODO: GPS stuff isn't great yet :)");
